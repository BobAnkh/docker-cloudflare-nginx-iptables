...
###
 ...
 # @Date         : 2021-10-08 16:28:44
 # @LastEditors  : BobAnkh
 # @LastEditTime : 2021-10-08 16:36:53
 # @Description  : 
...
chain=$prefix-$(openssl rand 3 -hex)v6

echo "# Generated by iptables.sh: $service"
echo "# Public interface: $IF"
ip6tables-save -t mangle | sed "/$prefix-/d;/^COMMIT$/d;/^#/d"
...
# Allow source IPs
 for addr in $(curl https://www.cloudflare.com/ips-v6); do
